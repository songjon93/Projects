...
public class DirectedAdjListMap<V, E> extends AdjacencyListGraphMap<V, E> {
    ...
    public Iterable<Edge<E>> incidentEdgesIn(Vertex<V> v){
    	ArrayList <Edge<E>> edgeList = new ArrayList<Edge<E>>();
    	for(Edge<E> edge: EList){
    		if (isDirected(edge) && endVertices(edge)[1].equals(v)) edgeList.add(edge);
    	}
    	return edgeList;
    }
    ...
    public Iterable<Edge<E>> incidentEdgesOut(Vertex<V> v){
    	ArrayList<Edge<E>> edgeList = new ArrayList<Edge<E>>();
    	for(Edge<E> edge: EList){
    		if (isDirected(edge) && endVertices(edge)[0].equals(v)) edgeList.add(edge);
    	}
    	return edgeList;
    }
    ...
    public int inDegree(Vertex<V> v){
    	int n = 0;
    	for(Edge<E> edge: incidentEdgesIn(v)){
    		n ++;
    	}
    	return n;
    }
    ...
    public int outDegree(Vertex<V> v){
    	int n = 0;
    	for(Edge<E> edge: incidentEdgesOut(v)){
    		n ++;
    	}
    	return n;
    }
